...
List the key technologies and frameworks:  
- **Frontend**: Next.js 15, Shadcn, TypeScript, Zustand, SWR  
- **Backend**: Spring Boot, Spring Security, WebSockets, JPA (Hibernate)  
- **Database**: PostgreSQL  
- **Other tools**: Docker, Axios, Zod  
...
Provide installation and execution steps:  
```bash
# Clone the repo
git clone https://github.com/HAnthony007/computer_monitoring.git
cd computer_monitoring
